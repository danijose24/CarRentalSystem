	...
	<div id="site_content">		
	  ...
	  <div id="content">
        <div class="content_item">
		  <h1 style="color:silver;">Admin Login </h1> 
              <form action="checkAdmin.html" method="post">
                  ...
                  <h1 style="color:silver;">Log In</h1>
                   ...
                   <tr>
                    ...
                    <tr>
               <td></td>
               <td> <input class="btn btn-default" type="submit" value="LogIn"> <a href="mainHome.html"><button class="btn btn-default" type="button">Go Back</button></a></td>
           </tr>
