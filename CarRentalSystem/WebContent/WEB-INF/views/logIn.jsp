	...
	<div id="site_content">		
	  ...
	  <div id="content">
        <div class="content_item">
		  <h1 style="color:silver;">Login here to Book your Car</h1> 
              <form action="checkUser.html" method="post" >
                  <center> <br>
                  <h1 style="color:silver;">Log In</h1>
                   ...
                   <tr>
                    ...
                    <tr>
               <td></td>
               <td> <input class="btn btn-default" type="submit" value="LogIn"> <a href="goSignUp.html"><button class="btn btn-default" type="button">Go Back</button></a></td>
           </tr>
