...
<body>
	...
	<nav>
       ...
       <div class="content_item">
           ...
           <table>
               <tr>
               <td><h3 style="color:silver;"><label for="carType">Car Type</label></h3></td>
               <td>
               ...
               <tr>
                   <td><h3 style="color:silver;"><label for="registerNumber">Register Number&nbsp;&nbsp;&nbsp;</label></h3></td>
               ...
               <tr>
                   <td><h3 style="color:silver;"><label for="imageUrl">Upload a Image here&nbsp;&nbsp;&nbsp;</label></h3></td>
